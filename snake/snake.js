...
window.onload = function() {
    ...
    var images = [];
    var tileimage;
    var appleImage; // Add this line for the custom apple image
    var titleImage; // Add this line for the title image (2.png)
    ...
    function loadImages(imagefiles) {
        ...
        loadcount = 0;
        loadtotal = imagefiles.length + 2; // +2 for the apple image and title image
        preloaded = false;
        ...
        appleImage.src = "3.jpg"; // Use 3.jpg as the apple image
        ...
        titleImage.src = "2.png"; // Use 2.png as the title image
    ...
    // Create objects
    var snake = new Snake();
    var level = new Level(20, 15, 64, 64);
    ...
    function render() {
        ...
        // Draw title image at top left
        if (titleImage) {
            var titleWidth = 200;
            var titleHeight = 100;
            var titleX = 50; // Position from left instead of center
            var titleY = 20;
            context.drawImage(titleImage, titleX, titleY, titleWidth, titleHeight);
        }
        
        // Draw "SNAKE" text below the title image
        context.fillStyle = "#ffffff";
        context.font = "bold 48px Verdana";
        drawCenterText("SNAKE", 0, 140, canvas.width);
        
        // Draw "Game powered by:@https://x.com/Amordeev" text
        context.fillStyle = "#888888";
        context.font = "16px Verdana";
        drawCenterText("Game powered by: @https://x.com/Amordeev", 0, 180, canvas.width);
        ...
        for (var i=0; i<level.columns; i++) {
            for (var j=0; j<level.rows; j++) {
                ...
                if (tile == 0) {
                    ...
                    // Draw the custom apple image at tile size for better quality
                    var appleSize = level.tilewidth; // Make apple same size as tile
                    var appleX = tilex; // Position at tile location
                    var appleY = tiley;
                    context.drawImage(appleImage, appleX, appleY, appleSize, appleSize);
                }
            }
        }
    }
